...
import Like2 from '../../../../public/img/me-gusta.png'
        ...
        <section className="container-post1">
            ...
            <div className='container-post-info'>
                ...
                <nav className="container-reaction">
                    <div className='interaction'><img className='img-reaction' src={Like} alt="Me gusta" /><h6><b>{number}</b> <a className='enlace' href='#'>Me gusta</a></h6></div>
                    <div className='interaction'><img className='img-reaction' src={Comentario} alt="Comentar" /> <h6><b>{number2}</b> <a className='a' href='#'>Comentarios</a></h6></div>
                    <div className='interaction'><img className='img-reaction' src={Compartir} alt="Compartir" /> <h6><b>{number3}</b> <a className='enlace' href='#'>Compartir</a></h6></div>
                </nav>
            </div>
            <nav className='container-interaction'>
                <div className='interaction-post'><img className='img-reaction2' src={Like2} alt="Me gusta" /><h5>Me gusta</h5></div>
